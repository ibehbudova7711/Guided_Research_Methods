...
OUTPUT_FOLDER = "results/roberta_results"
...
def create_visualizations():
    ...
    plt.title(
        "RoBERTa Preference Across CrowS-Pairs Examples"
    )
    ...
    plt.savefig(
        f"{OUTPUT_FOLDER}/overall_preference.png",
        dpi=300
    )
    ...
    plt.title(
        "RoBERTa Stereotypical Preference Rate by Bias Category"
    )
    ...
    plt.savefig(
        f"{OUTPUT_FOLDER}/category_preference.png",
        dpi=300
    )
